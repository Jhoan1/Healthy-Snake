...
if(Mundo.existeCerveza == false && Mundo.tiempoFood %73==0){
  ...
  return update(Mundo, {snake1: moveSnake(Mundo.snake1, Mundo.dir1), snake:  moveSnake(Mundo.snake, Mundo.dir),tiempoFood: Mundo.tiempoFood+1,limitado:false}) ;
 } 
}
...
function onKeyEvent (Mundo, keyCode) {
  ...
  if(Mundo.borracho == false){
    if(keyCode == UP_ARROW && Mundo.limitado == false && Mundo.dir.y != 1){
     return update(Mundo, {limitado: true, dir: {y: -1, x: 0}});
  }
  else if(keyCode == DOWN_ARROW && Mundo.limitado == false && Mundo.dir.y != -1){
     return update(Mundo, {limitado: true, dir: {y: 1, x: 0}});
  }
  else if(keyCode == LEFT_ARROW && Mundo.limitado == false && Mundo.dir.x != 1){
   return update(Mundo, {limitado: true, dir: {y: 0, x: -1}});
  }
  else if(keyCode == RIGHT_ARROW && Mundo.limitado == false && Mundo.dir.x != -1){
    return update(Mundo, {limitado: true, dir: {y: 0, x: 1}});
  }
...
//PARA LA SEGUNDA SERPIENTE
 ...
 // si la serpiente 2 no está ebria
  if(Mundo.borracho1 == false){
    if(keyCode == 87 && Mundo.limitado == false && Mundo.dir1.y != 1){
     return update(Mundo, {limitado: true, dir1: {y: -1, x: 0}});
  }
  else if(keyCode == 83 && Mundo.limitado == false && Mundo.dir1.y != -1){
    return update(Mundo, {limitado: true, dir1: {y: 1, x: 0}});
  }
  else if(keyCode == 65 && Mundo.limitado == false && Mundo.dir1.x != 1){
    return update(Mundo, {limitado: true, dir1: {y:0, x:-1}})
  }
   else if(keyCode == 68 && Mundo.limitado == false && Mundo.dir1.x != -1){
    return update(Mundo, {limitado: true, dir1: {y:0, x:1}})
     }
      else{
   return update(Mundo, {})
