...
function ubicarComida(Mundo,snakes,snakes1){
 ...
 if(ramdomF.x == Mundo.food1.x && ramdomF.y == Mundo.food1.y ||
    ...
    ramdomF.x == Mundo.food2.x&&ramdomF.y == Mundo.food2.y){
...
/*
contrato: Mundo,object -> object
propósito: retorna el ultimo elemento de la snake.
prototipo:   ultimo2(snake)
ejemplos:
 ultimo2(snake: [{ x: 4, y: 1 },{ x: 3, y: 1 }, { x: 2, y: 1 }, { x: 1, y: 1 }]) -> { x: 1, y: 1 }
*/
...
if(Mundo.dir.x == 1){
    return update(Mundo, { food: ubicarComida(Mundo,Mundo.snake,Mundo.snake1) , snake: concat(cons({x:(first(Mundo.snake).x)+1, y:first(Mundo.snake).y},Mundo.snake),ultimo2(Mundo.snake)),puntaje:actualizoP(Mundo.puntaje,+1),borracho:false}) ;
  }
  else if(Mundo.dir.x == -1){
    return update(Mundo,{ food: ubicarComida(Mundo,Mundo.snake,Mundo.snake1) , snake: concat(cons({x:(first(Mundo.snake).x)-1, y:first(Mundo.snake).y},Mundo.snake),ultimo2(Mundo.snake)),puntaje:actualizoP(Mundo.puntaje,+1),borracho:false}) ;
  }
  else if(Mundo.dir.y == 1){
    return update(Mundo,{ food:  ubicarComida(Mundo,Mundo.snake,Mundo.snake1) , snake: concat(cons({x:(first(Mundo.snake).x), y:first(Mundo.snake).y+1},Mundo.snake),ultimo2(Mundo.snake)),puntaje:actualizoP(Mundo.puntaje,+1),borracho:false}) ;
  }
  else if(Mundo.dir.y == -1){
    return update(Mundo, { food: ubicarComida(Mundo,Mundo.snake,Mundo.snake1), snake:  concat(cons({x:(first(Mundo.snake).x), y:first(Mundo.snake).y-1},Mundo.snake),ultimo2(Mundo.snake)),puntaje:actualizoP(Mundo.puntaje,+1),borracho:false}) ;
  }
...
if(Mundo.dir1.x == 1){
    return update(Mundo, { food: ubicarComida(Mundo,Mundo.snake,Mundo.snake1) , snake1: concat(cons({x:(first(Mundo.snake1).x)+1, y:first(Mundo.snake1).y},Mundo.snake1),ultimo2(Mundo.snake1)),puntaje1:actualizoP(Mundo.puntaje1,+1),borracho1:false}) ;
  }
  else if(Mundo.dir1.x == -1){
    return update(Mundo,{ food:  ubicarComida(Mundo,Mundo.snake,Mundo.snake1) , snake1: concat(cons({x:(first(Mundo.snake1).x)-1, y:first(Mundo.snake1).y},Mundo.snake1),ultimo2(Mundo.snake1)),puntaje1:actualizoP(Mundo.puntaje1,+1),borracho1:false}) ;
  }
  else if(Mundo.dir1.y == 1){
    return update(Mundo,{ food:  ubicarComida(Mundo,Mundo.snake,Mundo.snake1) , snake1: concat(cons({x:(first(Mundo.snake1).x), y:first(Mundo.snake1).y+1},Mundo.snake1),ultimo2(Mundo.snake1)),puntaje1:actualizoP(Mundo.puntaje1,+1),borracho1:false}) ;
  }
  else if(Mundo.dir1.y == -1){
    return update(Mundo, { food:  ubicarComida(Mundo,Mundo.snake,Mundo.snake1), snake1: concat(cons({x:(first(Mundo.snake1).x), y:first(Mundo.snake1).y-1},Mundo.snake1),ultimo2(Mundo.snake1)),puntaje1:actualizoP(Mundo.puntaje1,+1),borracho1:false}) ;
  }
...
if(Mundo.dir1.x == 1){
    return update(Mundo, {
     food2: {x:1000,y:1000} ,
     snake1: cons({x:(first(Mundo.snake1).x)+1, y:first(Mundo.snake1).y},Mundo.snake1),
    ...
    return update(Mundo,{
     food2:  {x:1000,y:1000} ,
     snake1: cons({x:(first(Mundo.snake1).x), y:first(Mundo.snake1).y+1},Mundo.snake1),
     puntaje1:actualizoP(Mundo.puntaje1,-1),
     borracho1:true,
     existeCerveza:false
   }) ;
...
if(Mundo.existeCerveza == false && Mundo.tiempoFood %73==0){
    return update(Mundo, {
     food2: ubicarComida(Mundo,Mundo.snake,Mundo.snake1),
     existeCerveza:true ,
  });
 ...
 return update(Mundo, {snake1: moveSnake(Mundo.snake1, Mundo.dir1), snake:  moveSnake(Mundo.snake, Mundo.dir),tiempoFood: Mundo.tiempoFood+1,limitado1:false, limitado2:false}) ;
}
}
...
function onKeyEvent (Mundo, keyCode) {
 ...
 if(Mundo.borracho == false){
   if(keyCode == UP_ARROW && Mundo.limitado1 == false && Mundo.dir.y != 1){
    return update(Mundo, {limitado1: true, dir: {y: -1, x: 0}});
 }
 else if(keyCode == DOWN_ARROW && Mundo.limitado1 == false && Mundo.dir.y != -1){
    return update(Mundo, {limitado1: true, dir: {y: 1, x: 0}});
 }
 else if(keyCode == LEFT_ARROW && Mundo.limitado1 == false && Mundo.dir.x != 1){
  return update(Mundo, {limitado1: true, dir: {y: 0, x: -1}});
 }
 else if(keyCode == RIGHT_ARROW && Mundo.limitado1 == false && Mundo.dir.x != -1){
   return update(Mundo, {limitado1: true, dir: {y: 0, x: 1}});
 }
 }
...
// si la serpiente 2 no está ebria
 if(Mundo.borracho1 == false){
   if(keyCode == 87 && Mundo.limitado2 == false && Mundo.dir1.y != 1){
    return update(Mundo, {limitado2: true, dir1: {y: -1, x: 0}});
 }
 else if(keyCode == 83 && Mundo.limitado2 == false && Mundo.dir1.y != -1){
   return update(Mundo, {limitado2: true, dir1: {y: 1, x: 0}});
 }
 else if(keyCode == 65 && Mundo.limitado2 == false && Mundo.dir1.x != 1){
   return update(Mundo, {limitado2: true, dir1: {y:0, x:-1}})
 }
  else if(keyCode == 68 && Mundo.limitado2 == false && Mundo.dir1.x != -1){
   return update(Mundo, {limitado2: true, dir1: {y:0, x:1}})
    }
     else{
  return update(Mundo, {})
